...
venue: "National Centre for Biosecurity and Infectious Disease"        # brief name of host site without address (e.g., "Euphoric State University")
address: "66 Ward St, Wallaceville, Upper Hutt 5018"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "-41.131402, 175.057558"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "Oct 4th & 8th, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 4:30 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2019-10-04      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2019-10-08        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Ben Waite","Joep de Ligt","David Eccles"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Alessandra Santana"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["ben.waite@esr.cri.nz","Joep.DeLigt@esr.cri.nz"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.carpentries.org/2019-10-04-ncbid            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<p>
  ...
  <b>During the ESR workshops, participants will be provided with laptops to use that contain this software pre-installed. Setup for personal/home use of the software is described below.</b>
</p>
<p>
